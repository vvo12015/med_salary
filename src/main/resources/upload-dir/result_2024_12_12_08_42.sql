...
UNION ALL 
SELECT '845', N'Ігнатишак Олександра Михайлівна', N'Інфекційне відділення', 3, N'лікар-інфекціоніст', '1998-12-01', 0,75, 0,75, 1,00, 1.0, 40.0, 0, 0, 2493.9758, 333.9759, 8, 0.0, 0.0, 0, 0.0, 0, 2160.0, GETDATE()
UNION ALL 
