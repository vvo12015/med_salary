        ...
        implements ExcelReader<NszuDecryption, NszuDecryptionDTO>
{
    ...
    public static final int START_NSZU_ROW_NUMBER = 4;
    ...
    public NszuDecryptionDTO toDTOFromString(String stringDTO) {
            ...
            int index = 0;
                ...
                dto.setStatisticStatus(YES.equals(stringList.get(index++)));
                dto.setReportStatus(YES.equals(stringList.get(index++)));
